...
async function handler(req, res) {
  ...
  try {
    ...
    /* checkout.session.expired is handled in HQ, not here. HQ records the
       abandoned cart and sends the branded 2-hour / 1-day / 3-day reminder
       sequence, so a second sender in this webhook would only double up. */
